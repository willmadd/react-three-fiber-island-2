...
import islandSrc from '../../../../public/img/islandheightmap3.png'
...
const Shader = (props) => {
  ...
  return (
    <>
      <PerspectiveCamera makeDefault position={[50, 50, 250]} />
  ...
  return (
    <Suspense fallback={null}>
      ...
      <Float
        ...
        // floatingRange={[0, 0.01]} // Range of y-axis values the object will float within, defaults to [-0.1,0.1]
      >
        <BoatModel position={[0, -0, 98]} rotation={[0, 1.3, 0.02]} />
      </Float>
    </Suspense>
  )
}
  ...
  return (
    <mesh rotation={[-Math.PI / 2, 0, 0]} position={[0, -1.5, 0]}>
      {/* <PerspectiveCamera
        ...
        position={[85, 75, 70]}
      /> */}
      <planeBufferGeometry args={[320, 320, 16, 16]} />
      <meshStandardMaterial
        // wireframe
        displacementMap={islandHeightMap}
        displacementScale={185}
