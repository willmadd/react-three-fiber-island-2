...
const Scene = (props) => {
  ...
  useFrame((state, delta) => {
    ...
    cameraRef.current.position.x = fishingBoatRef.current.position.x + 510
    cameraRef.current.position.y = fishingBoatRef.current.position.y + 100
    cameraRef.current.position.z = fishingBoatRef.current.position.z + 510
    // .set([
    //   fishingBoatRef.current.position.x,
    //   fishingBoatRef.current.position.y,
    //   fishingBoatRef.current.position.z,
    // ])
  })
